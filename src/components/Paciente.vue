...
<template>
    <div class="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <div class="grid md:grid-cols-2  gap-5 mt-10 ">
            ...
            <button type="button"
                class="block w-full py-2 px-10 bg-red-600 hover:bg-red-700 text-white font-bold uppercase rounded-lg" @click="$emit('eliminar-paciente. paciente.id)">Eliminar</button>
        </div>
    </div>
</template>